# league data ----
league <- jsonlite::read_json("https://www55.myfantasyleague.com/2022/export?TYPE=league&L=63018&APIKEY=&JSON=1") %>% 
  purrr::pluck("league")
...
## roster data ----
roster <- jsonlite::read_json("https://www55.myfantasyleague.com/2022/export?TYPE=rosters&L=63018&APIKEY=&FRANCHISE=&W=&JSON=1") %>% 
