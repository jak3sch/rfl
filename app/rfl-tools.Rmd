...
> wenn Error: [Object object] angezeigt wird, wähle einfach ein Asset aus und die getätigten Trades sollten erscheinen
...
DT::renderDataTable({
  table_data <- trades %>% 
    ...
    dplyr::filter(grepl(input$tradeHistoryAssets, as.character(asset_ids)) & date >= input$tradeHistoryDate[1] & date <= input$tradeHistoryDate[2]) %>% 
